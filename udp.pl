...
if ($help || !$ip) {
 ...
 https://www.youtube.com/channel/UCq8OTEYfc5Ye13BxpYdmrog
...
print "Atacando ip: $ip " . ($port ? $port : "By:") . " XxASxX_YBanY " . 
  ($size ? "$size-byte" : "UDP Oficial da: OnFall Team") . " https://www.youtube.com/channel/UCq8OTEYfc5Ye13BxpYdmrog" . ($time ? " for $time seconds" : "") . "\n";
